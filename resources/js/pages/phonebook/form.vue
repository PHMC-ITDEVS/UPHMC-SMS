...
<script>
    ...
    import PhonebookPreview from './steps/preview';
    ...
    export default {
        ...
        methods: {
            ...
            onNext() {
                ...
                PhonebookServices.validate(this.context.data)
                .then((response) => {
            ...
            updateData(data, id) {
                if (this.context.loading) return;
                this.context.loading = true;
                PhonebookServices.update(data, id)
                .then((response) => {
                    this.$toast.add({ severity: 'success', summary: 'Success!', detail: response.data.message, life: 3000 });
                    this.$emit('hideModal');
                })
