<template>
    <div>
        ...
        >
            ...
            <DepartmentForm @hideModal="successEvent" :item="dialog.form" @close="dialog.show = !1" v-if="!dialog.loading"/>
    ...
    export default {
        ...
        methods: {
            ...
            getTableData(page) {
                ...
                DepartmentServices.list(this.table.params)
                .then((response) => {
            ...
            deleteData(item) {
                this.$confirm.require({
                    ...
                    accept: () => {
                        DepartmentServices.remove(item.id)
                        .then((response) => {
            ...
            viewData(item) {
                ...
                DepartmentServices.get(item.id)
                .then((response) => {
                    let data = response.data.data;
                    let params = { ...data };
